...
package com.android.settings.gnosis.custom;
...
public class DarkModePreferenceController extends DeveloperOptionsPreferenceController
    ...
    @VisibleForTesting
    DarkModePreferenceController(Context context, UiModeManager uiModeManager) {
        super(context);
